...
(
    ...
    output reg [255:0]	o_mem_bus_data,
    input  [255:0]	i_mem_bus_data,
    output reg bus_re,
    output reg bus_we,
...
wire flush_csr_clr_nc;
wire [255:0] o_mem_bus_data_1;
wire [255:0] o_mem_bus_data_2;
wire freeze_int1; 
wire bus_rq_int1;
wire bus_re_int1;
wire bus_cntrl_int1;
...
always @(*) begin
    case(state)
        CHECK : begin
            ...
            o_mem_bus_data 	= bus_clsh ? o_mem_bus_data_1 : (bus_rq_int1 ? o_mem_bus_data_1 : o_mem_bus_data_2);
        ...
        BUS_CLSH: begin
            ...
            o_mem_bus_data 	= bus_clsh ? o_mem_bus_data_1 : o_mem_bus_data_2;
        ...
        BUS_SER : begin
            ...
            o_mem_bus_data 	= o_mem_bus_data_2;
        ...
        HOLD: begin
            ...
            if(~freeze_int1) begin
            	...
            	o_mem_bus_data 	= o_mem_bus_data_1;
...
dcache_ram_fsm drf0( .clk(clk),
                     ...
                     .i_bus_data(i_mem_bus_data),
                     .o_bus_data(o_mem_bus_data_1),
                     .bus_addr(bus_addr_int1),
                     .hit(hit_a),
                     .mis(mis_a),
                     .bus_re(bus_re_int1),
...
dcache_ram_fsm drf1( .clk(clk),
                     ...
                     .cache_flush(1'b0),
		     .flush_csr_clr(flush_csr_clr_nc),
                     .cache_flush_o(cache_flush_int2),
                     .bus_rq(bus_rq_int2),
                     .bus_rdy(bus_rdy_int2),
                     .i_bus_data(i_mem_bus_data),
                     .o_bus_data(o_mem_bus_data_2),
                     .bus_addr(bus_addr_int2),
                     .hit(hit_b),
                     .mis(mis_b),
                     .bus_re(bus_re_int2),
