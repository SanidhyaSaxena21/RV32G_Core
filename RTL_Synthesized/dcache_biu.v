...
wire [255:0] i_bus_data;
wire [255:0] o_bus_data;
...
MEMORY_REQUEST_MODULE INTERFACE_ROUTER (
   ...
   .o_bus_data(o_bus_data),     //to be able to communicate with proc interface 
   .i_bus_data(i_bus_data),     //to be able to communicate with proc interface 
