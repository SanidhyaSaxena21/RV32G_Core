...
main:
        ...
        bltu    x1, x2, branch1 # if x1 < x2, branch to branch1
        j       fail1           # jump to fail
        
        branch1: 
        bltu    x2, x1, fail1   # if x2 < x1, branch to fail
        
        # compare signed numbers
        li      x3, -50         # set x3 to -50 (0xFFFFFFCE)
        bltu    x3, x1, fail2   # if x3 < x1 (unsigned), branch to fail
        
        # compare equal numbers
        bltu    x3, x3, fail3   # if x3 < x3, branch to fail
