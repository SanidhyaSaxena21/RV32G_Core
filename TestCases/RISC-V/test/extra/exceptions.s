...
main:
        ...
        la  x2, __ram_start                  # set x2 to 0x1008 
...
trap_address_1:
        ...
        la x8, __ram_start                   # set x8 to 0x100a  (value of mtval or the misaligned address)
        addi x8,x8,2
...
trap_address_2:
        ...
        add x8,x0,x2                   # set x8 to 0x100a  (value of mtval or the misaligned address)
        addi x8,x8,1
        beqz x5, fail0                  # make sure x5 has value
        beqz x8, fail0                  # make sure x5 has value
...
trap_address_3:        
        ...
        nop
        csrr x4, mcause                 # set x4 to mcause value 
        li  x5, 0x0000000b              # set x5 to 0x0000000b (expected mcause value for ecall)
        beqz x5, fail0                  # make sure x5 has value
